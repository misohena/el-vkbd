...
Based on vkbd-layout-10x9, reduced to 7 rows. Most symbols require shift to enter, but some can be entered without shift.

** vkbd-layout-10x6

[[file:screenshot/layout-10x6.png]]

The most compact layout with one more row removed from vkbd-layout-10x7. Almost all symbols require shift to enter. Also, Ins and Del keys are omitted.
