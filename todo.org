...
* Inbox
** TODO redirect-frame-focusを使うかどうか
使った方が安定する気がする。

** TODO 修飾キーの適用順を統一する必要はあるのか
...
** TODO switch-frameイベントをできるだけ妨害したらどうなるか
...
** TODO 押しながら移動して離した場合に何か有用な働きをさせたい
- 離した場所のキーだけが入力される(普通)
- 経路のキーが全て入力される
...
** SOMEDAY 修飾キーのロックが2回目以降の非仮想キーに対して適用されない
...
** DONE タッチでキーを押したときに2回押されることがあるのを直す
...
** DONE 修飾キーと通常のキー入力を組み合わせられるようにする
...
** DONE text-conversion-styleを制御する？
